...
# This method does not take advantage of vulnerabilities in the server software but instead takes advantage of limits on the number of connections the server can handle simultaneously.ss